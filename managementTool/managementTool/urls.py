...
urlpatterns = [
    ...
    #path('edit/building/<id>/edit_alias' , views.edit_alias_building , name = 'edit_alias_building'),
    ...
    #path('edit/campus/<id>/edit_alias' , views.edit_alias_campus , name = 'edit_alias_campus'),
    ...
    #path('edit/room/<id>/edit_alias' , views.edit_alias_room , name = 'edit_alias_room'),
